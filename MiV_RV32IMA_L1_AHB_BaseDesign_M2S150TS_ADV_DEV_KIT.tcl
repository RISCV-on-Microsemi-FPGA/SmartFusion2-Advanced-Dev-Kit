...
append Libero_project_name "_M2S150TS_ADV_DEV_KIT"
append project_dir "_M2S150TS_ADV_DEV_KIT"
append project_folder_name "_M2S150TS_ADV_DEV_KIT"
...
proc create_new_project_label { }\
{
	...
	puts "-------MiV_RV32IMA_L1_AHB_BaseDesign_M2S150TS_ADV_DEV_KIT----------------"
    puts "-------------------------------------------------------------------------"
}
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	run_tool -name {VERIFYTIMING}
    export_prog_job \
        -job_file_name {BaseDesign_M2S150TS_ADV_DEV_KIT-ProgramFile} \
        -export_dir {./} \
...
After script execution the message that displayed information was outdated. Instead of providing you with an "EXPORT_PROGRAMMING_FILE" it provided you with wrong information to use "EXPORT_BITSTREAM"
