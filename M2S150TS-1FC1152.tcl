...
append Libero_project_name_ahb "_M2S150TS-1FC1152"
append project_dir_ahb "_M2S150TS-1FC1152"
append project_folder_name_ahb "_M2S150TS-1FC1152"
...
append Libero_project_name_axi "_M2S150TS-1FC1152"
append project_dir_axi "_M2S150TS-1FC1152"
append project_folder_name_axi "_M2S150TS-1FC1152"
...
proc create_new_project_label_ahb { }\
{
	...
	puts "--------MiV_RV32IMA_L1_AHB_BaseDesign_M2S150TS-1FC1152-------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
proc create_new_project_label_axi { }\
{
    ...
    puts "-------------------------------------------------------------------------"
    puts "-----------------------CREATING NEW PROJECT------------------------------"
	puts "--------MiV_RV32IMA_L1_AXI_BaseDesign_M2S150TS-1FC1152-------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
if {"$target" == "AHB"} then {
	if {[file exists $project_dir_ahb] == 1} then {
		...
		source ./import/components/M2S150TS-1FC1152/AHB/import_component_and_constraints_sf2_m2s150ts_ahb.tcl
		save_project
		puts "-------------------------------------------------------------------------"
		puts "-------------------------------SUCCESS!----------------------------------"
		puts "-------------------------------------------------------------------------"
	...
	if {[file exists $project_dir_axi] == 1} then { 
		...
		source ./import/components/M2S150TS-1FC1152/AXI/import_component_and_constraints_sf2_m2s150ts_axi.tcl
		save_project
		puts "-------------------------------------------------------------------------"
		puts "-------------------------------SUCCESS!----------------------------------"
		puts "-------------------------------------------------------------------------"
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {BaseDesign_M2S150TS-AHB-ProgramFile} \
		...
		export_prog_job \
			-job_file_name {BaseDesign_M2S150TS-AXI-ProgramFile} \
			-export_dir {./FlashPro_Express_Projects} \
			-bitstream_file_type {TRUSTED_FACILITY} \
			-bitstream_file_components {FABRIC ENVM} \
			-bitstream_file_components {}
