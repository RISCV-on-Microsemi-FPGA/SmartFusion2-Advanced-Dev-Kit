...
proc create_new_project_label_axi { }\
{
	...
	puts "--------MiV_RV32IMA_L1_AXI_BaseDesign_SF2_ADV_DEV_KIT_TS-----------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
    ...
    puts "-------------------------------------------------------------------------"
    puts "-----------------------CREATING NEW PROJECT------------------------------"
	puts "-------MiV_RV32IMA_L1_AHB_BaseDesign_SF2_ADV_DEV_KIT_TS------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
# ##
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {BaseDesign_SF2_Adv_Dev_Kit_TS_AHB_ProgramFile} \
		...
		export_prog_job \
			-job_file_name {BaseDesign_SF2_Adv_Dev_Kit_TS_AXI_ProgramFile} \
			-export_dir {./../FlashPro_Express_Projects/Programming_Files} \
			-bitstream_file_type {TRUSTED_FACILITY} \
			-bitstream_file_components {}
		save_project
