set project_folder_name_axi MiV_AXI_SF2_Adv_Dev_Kit
set project_dir_axi "./$project_folder_name_axi"
set Libero_project_name_axi MiV_AXI_BaseDesign

set project_folder_name_ahb MiV_AHB_SF2_Adv_Dev_Kit
...
proc create_new_project_label_axi { }\
{
	...
	puts "----------MiV_RV32IMA_L1_AXI_BaseDesign_SF2_ADV_DEV_KIT------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
    ...
    puts "-------------------------------------------------------------------------"
    puts "-----------------------CREATING NEW PROJECT------------------------------"
	puts "----------MiV_RV32IMA_L1_AHB_BaseDesign_SF2_ADV_DEV_KIT------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
if {"$target" == "AHB"} then {
	if {[file exists $project_dir_ahb] == 1} then {
		...
		source ./import/components/M2S150-1FC1152/AHB/import_component_and_constraints_sf2_adv_dev_kit_ahb.tcl
		save_project
		puts "-------------------------------------------------------------------------"
		puts "-------------------------------SUCCESS!----------------------------------"
		puts "-------------------------------------------------------------------------"
	...
	if {[file exists $project_dir_axi] == 1} then { 
		...
		source ./import/components/M2S150-1FC1152/AXI/import_component_and_constraints_sf2_adv_dev_kit_axi.tcl
		save_project
		puts "-------------------------------------------------------------------------"
		puts "-------------------------------SUCCESS!----------------------------------"
		puts "-------------------------------------------------------------------------"
...
# ##
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {BaseDesign_SF2_Adv_Dev_Kit_AHB_ProgramFile} \
		...
		export_prog_job \
			-job_file_name {BaseDesign_SF2_Adv_Dev_Kit_AXI_ProgramFile} \
			-export_dir {./../FlashPro_Express_Projects/Programming_Files} \
			-bitstream_file_type {TRUSTED_FACILITY} \
			-bitstream_file_components {}
		save_project
